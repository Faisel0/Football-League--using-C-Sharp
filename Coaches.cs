...
namespace crud_for_player
{
    public partial class Coaches : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO dbo.Coach(CoachID,PersonalID) VALUES (@CoachID,@PersonalID)", con);
            cmd.Parameters.AddWithValue("@CoachID", textBox1.Text);
            cmd.Parameters.AddWithValue("@PersonalID", textBox2.Text);
            cmd.ExecuteNonQuery();
            con.Close();
